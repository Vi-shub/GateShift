...
| `blog-k8s-2026-02/` | Kubernetes blog Ingress-NGINX behavioral quirks (2026-02-27) | 5 |
| `*.yaml` (root) | Extra local cases | 2 |

How to read results: [docs/SCOREBOARD.md](../../docs/SCOREBOARD.md) · gaps: [docs/CORPUS_GAPS.md](../../docs/CORPUS_GAPS.md) · quirks: [docs/BEHAVIORAL_FIDELITY.md](../../docs/BEHAVIORAL_FIDELITY.md)
